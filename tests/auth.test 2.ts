import { api, prisma, TEST_USER, NEW_USER, cleanupTestUser } from "./setup.js";
...
describe("Auth Endpoints", () => {
  ...
  describe("POST /api/auth/register", () => {
    it("should register a new user successfully", async () => {
      const response = await api.post("/api/auth/register").send(NEW_USER);
  ...
  describe("POST /api/auth/refresh", () => {
    it("should refresh token with valid refresh token", async () => {
      ...
      const response = await api.post("/api/auth/refresh").set("Cookie", cookies || []);
    ...
    it("should reject refresh with invalid token", async () => {
      const response = await api.post("/api/auth/refresh").send({ refreshToken: "invalid-token" });
